...
_SUPPORTED_SCHEMA_MIGRATION_VERSIONS: Final = tuple(range(1, 27))
    ...
    *,
    ...
    if expected_versions != _SUPPORTED_SCHEMA_MIGRATION_VERSIONS:
        raise Phase1APipelineError(
            "Phase1A requires the checked-in PostgreSQL migrations 0001 through 0026 exactly"
        )
    ...
    if applied != expected_identity:
        raise Phase1APipelineError(
            "PostgreSQL schema migrations do not exactly match checked-in versions 0001-0026"
        )
